    ...
    <section id={"projects"} className="max-w-[48rem] flex flex-col">
      ...
      <div className="flex flex-col gap-12 p-8">
        {projectsData.map((project, index) => (
          <section
            key={project.title}
            className="group hover:scale-105 hover:bg-[#3b3b3b7c] transition overflow-hidden relative flex flex-col sm:items-start even:sm:items-end items-center rounded-sm bg-black/[0.5] p-8"
          >
